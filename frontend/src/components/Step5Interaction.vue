              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewer that conducts parallel multi-turn dialogues with simulated agents to collect unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter your question for all selected targets..."
                rows="3"
              ></textarea>
            </div>
...
const selectReportAgentChat = () => {
  ...
  // Restore Report Agent's chat records
...
const renderMarkdown = (content) => {
  ...
  // Fix non-contiguous ordered list numbering: maintain incrementing numbers when single-item <ol> blocks are separated by paragraph content
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize reddit platform reply, fallback to twitter

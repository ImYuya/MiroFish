<template>
  <div class="process-page">
    ...
    <div class="main-content">
      <!-- Left Panel: Real-time Graph Visualization -->
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes the content and auto-generates an ontology structure suitable for opinion simulation (entity types + relation types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunks documents and calls Zep API to build a knowledge graph, extracting entities and relations
                </div>
              </div>

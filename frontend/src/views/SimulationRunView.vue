...
// Get maxRounds from query params at init, ensuring child components receive it immediately
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        addLog(`Failed to close simulation environment, force stopping...`)
        try {
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh won't show full-screen loading to avoid flickering

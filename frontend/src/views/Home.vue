  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">Versatile Collective Intelligence Engine</span>
          ...
          <div class="hero-desc">
            <p>
              Even with just a paragraph of text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span> from the real-world seeds within. Inject variables from a god's-eye view to find <span class=”highlight-code”>”local optima”</span> through complex crowd interactions in dynamic environments
            </p>
            <p class="slogan-text">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Reality seed extraction & memory injection & GraphRAG construction</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity extraction & profile generation & agent parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse requirements & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent in the simulated world & with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction in natural language (e.g. What would happen if Tesla cuts Model 3 prices by 20%?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate to Process page (use 'new' to indicate new project)
    router.push({
      name: 'Process',

...
Simple command/response pattern implemented via the filesystem:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview on both; in single-platform, interview on that platform
            timeout: Timeout in seconds

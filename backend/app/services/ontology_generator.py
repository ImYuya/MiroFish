...
class OntologyGenerator:
    ...
    def _build_user_message(
        ...
        if len(combined_text) > self.MAX_TEXT_LENGTH_FOR_LLM:
            ...
            combined_text += f"\n\n...(Original text has {original_length} characters, truncated to the first {self.MAX_TEXT_LENGTH_FOR_LLM} characters for ontology analysis)..."
...
4. All entity types must be real-world subjects that can speak out; abstract concepts are not allowed
...
"""
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            '# Ontology types (for reference only, used by LocalGraphStore)',

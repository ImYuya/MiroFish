...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation config parameters (timing, activity, posting frequency, etc.)
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found, please verify the graph is correctly built"
                self._save_simulation_state(state)
                return state

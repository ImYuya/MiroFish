...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        max_rounds: int = None,  # Max simulation rounds (optional, used to truncate overly long simulations)
        ...
        Args:
            ...
            max_rounds: Max simulation rounds (optional, used to truncate overly long simulations)
        ...
        # Always use run_parallel_simulation.py (supports --twitter-only / --reddit-only)
        ...
        try:
            ...
            # Pass platform flag for single-platform runs
            if platform == "twitter":
                cmd.append("--twitter-only")
            elif platform == "reddit":
                cmd.append("--reddit-only")

            # If max rounds is specified, add to command line arguments
            if max_rounds is not None and max_rounds > 0:
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If both platforms were running, both need to complete
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Clean up simulation run logs (used for force-restarting a simulation)
    ...
    def register_cleanup(cls):
        ...
        # In non-debug mode, this env var is absent, and registration is also needed
        ...
        def cleanup_handler(signum=None, frame=None):
            ...
            # Call original signal handlers to let Flask exit normally
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview both platforms and return integrated result
